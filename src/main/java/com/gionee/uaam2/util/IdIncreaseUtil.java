...
@Component
public class IdIncreaseUtil implements ApplicationContextAware {
	...
	@Deprecated
	public static String increaseIdOld(String objName){
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		IdIncreaseUtil.applicationContext = applicationContext;
	}
